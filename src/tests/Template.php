...
class Template
{
    ...
    /** 
     * * A currying function * 
     * Currying allows a function to be called incrementally. This means that if * a function accepts two arguments, it can be curried with only one * argument supplied, 
     * which returns a new function that will accept the * remaining argument and return the output of the original curried function * using the two supplied parameters.
     * Example:   
